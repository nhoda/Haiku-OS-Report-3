...
user with popup notifications for things like new e-mails and instant 
...
(Open Sound System), and many more. All media add-ons are subclassed 
objects of BMediaAddon. \cite{BMediaAddon} This was determined by looking
through the media\_addon\_sources, and the sources for specific media 
addons.
